...
class Admin:
        ...
        # Delete
            ...
            if(len(doctors) != 0):
                ...
                if(doctor_index >= 0 and doctor_index < len(doctors)):
                    ...
                    print('Doctor\'s ID successfully deleted')
                else:  #ToDo9
                    print("The ID Entered Is Incorrect")
        ...
        try:
            ...
            if self.find_index(doctor_index,doctors)!=False:
                ...
                if Patient.save_records(patients):
                    print('The patient is now successfully assign to the doctor.')
                else:
    ...
    def view_discharge(self, discharged_patients):
        ...
        for index, patient in enumerate(discharged_patients, start = 1):
            print(f"{index:2}|{patient.full_name():^30}|{patient.get_doctor():^30}|{patient._Patient__age:^5}|{patient._Patient__mobile:^15}|{patient._Patient__postcode:^10}")
        
        else:
            print('No patient is discharged')
    ...
    def update_details(self):
        ...
        if op == 1:
            #ToDo14
            username = input("Enter The new Password: ")
            self.__username = username
            print("Successsfully changed username")
        elif op == 2:
    ...
    def read_records():
        patients = []
        try:
            with open("HMS/patients.txt", 'r') as fd:
            ...
            if patient_index in range(len(patients)):
                ...
                for doctor in doctors:
                    if doctor.full_name() == old_doctor:
                       doctors.remove_patients(patients[patient_index].full_name())
                       break
